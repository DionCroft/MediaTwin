...
class ScanWorker(QObject):
    ...
    def run(self) -> None:
        ...
        try:
            ...
            self._total_videos_found = total
            self.video_count_found.emit(total)
            ...
            for index, video_path in enumerate(video_paths, start=1):
                ...
                self.progress.emit(index, total, video_path.name, duplicate_count)
    ...
    def _build_result(
        ...
        return ScanRunResult(
            ...
            total_files=self._total_videos_found or len(records),
